...
class queue
{
	...
	void flights_info()
	{
		...
		gotoxy(4,6);
		cout<<left<<setw(6)<<"1"<<setw(15)<<"PKR-108"<<setw(14)<<"Kabul"<<setw(17)<<"islamabad"<<setw(14)<<"11:00 PM"<<"100$";
		gotoxy(4,8);
		cout<<left<<setw(6)<<"2"<<setw(15)<<"PKR-320"<<setw(14)<<"islamabad"<<setw(17)<<"istanbul"<<setw(14)<<"12:00 PM"<<"250$";
		gotoxy(4,10);
		cout<<left<<setw(6)<<"3"<<setw(15)<<"PKR-170"<<setw(14)<<"london"<<setw(17)<<"paris"<<setw(14)<<"03:00 PM"<<"100$";
		gotoxy(4,12);
		cout<<left<<setw(6)<<"4"<<setw(15)<<"PKR-102"<<setw(14)<<"pesawar"<<setw(17)<<"kabul"<<setw(14)<<"05:00 AM"<<"500$";
		gotoxy(4,14);
		cout<<left<<setw(6)<<"5"<<setw(15)<<"PKR-101"<<setw(14)<<"peshawar"<<setw(17)<<"karachi"<<setw(14)<<"09:00 AM"<<"100$";	
	}
	void Menu()
	{
		gotoxy(2,2);	
		...
		cout<<"Main Menu"<<endl;
		gotoxy(28,1);
		cout<<"Reserve a seat for yourself !!"<<endl;
		gotoxy(4,6);
...
int main()
{
	...
	l:
	char c=getch();//get the chracter from the funcion and sores in the c
  		if(c>='1' && c<='8')
		{
		choice=c-48;
		cout<<c;
